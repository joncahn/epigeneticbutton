...
rule combined_analysis:
    input:
        expand("ChIP/mapped/merged__{analysis_sample_name}.bam", sample_name_analysis=analysis_samples[analysis_samples["data_type"] == "ChIP"].apply(sample_name_analysis, axis=1)),
