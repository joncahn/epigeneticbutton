...
rule make_chip_stats_pe:
    ...
    params:
        line = lambda wildcards: get_sample_info_from_name({wildcards.sample_name}, 'line'),
        tissue = lambda wildcards: get_sample_info_from_name({wildcards.sample_name}, 'tissue'),
        sample_type = lambda wildcards: get_sample_info_from_name({wildcards.sample_name}, 'sample_type'),
        replicate = lambda wildcards: get_sample_info_from_name({wildcards.sample_name}, 'replicate'),
        ref_genome = lambda wildcards: get_sample_info_from_name({wildcards.sample_name}, 'ref_genome')
    shell:
        """
