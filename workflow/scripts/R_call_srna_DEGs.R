...
if ( filename %in% c(paste0("results/combined/bedfiles/",refgenome,"__all_genes.bed"), paste0("results/combined/bedfiles/",refgenome,"__protein_coding_genes.bed"), paste0("genomes/",refgenome,"/",refgenome,"__all_TEs.bed")) ) {
